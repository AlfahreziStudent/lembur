...
<h1 class="font-bold text-slate-600 text-3xl">Judul</h1>
<div class="flex  text-sm font-normal items-center mt-1">
    ...
    <a href="#" class="text-slate-400">Judul</a>
</div>

{{-- Task --}}
<div class="garis mt-10 mb-3">
    <div class="bg-slate-100 pr-3 text-lg font-medium text-slate-600">Judul</div>
</div>

<a href="{{ route('buat-judul') }}" class="ml-auto shadow flex mb-5 mt-3 justify-center items-center text-sm py-3 font-semibold rounded text-white bg-green-500">
    <i data-feather="plus" width="24px" height="24px" class="mr-1"></i> TAMBAH JUDUL
</a>
...
<div class="relative ">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 data-table overflow-x-auto shadow-md">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
                <th class="px-6 py-3" scope="col">Nama Judul</th>
